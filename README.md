...
> Note: The bucket policy reference (`policy.txt`) is intentionally included both at the repo root for quick access and inside the `aws-devops-class` folder as part of the coursework structure.
